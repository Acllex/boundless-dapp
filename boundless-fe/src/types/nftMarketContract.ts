import { type ContractTransaction, type BytesLike as Arrayish, type BigNumberish } from 'ethers'
...
export interface NftMarketContract {
   ...
   */
  tokenByIndex(index: BigNumberish, overrides?: ContractCallOverrides): Promise<BigInt>
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
